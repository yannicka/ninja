...
const TurtleSpinningTop = preload("res://src/enemies/turtle_spinning_top.tscn")
...
func _on_area_2d_body_entered(body: Node2D) -> void:
	if body.has_method("kill_or_bounce"):
		var kill_or_bounce = body.kill_or_bounce()

		if kill_or_bounce == "bounce":
